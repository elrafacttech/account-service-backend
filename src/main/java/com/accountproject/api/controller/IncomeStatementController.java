...
public class IncomeStatementController {
	...
	/*
	 * @GetMapping("/getByBusinessId") public ResponseEntity<IncomeStatementRes>
	 * getIncomeStmt(@PathVariable Integer businessId) { IncomeStatementRes response
	 * = statementService.addIncomeStmt(); return ResponseEntity.ok(response); }
	 */

	@GetMapping("/getByBusinessId")
	public ResponseEntity<IncomeStatementRes> getIncomeStmt() {
		IncomeStatementRes response = statementService.getIncomeStmt();
		return ResponseEntity.ok(response);
	}
}
