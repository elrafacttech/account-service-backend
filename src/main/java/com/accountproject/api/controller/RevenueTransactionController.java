...
public class RevenueTransactionController {
	...
	@GetMapping("/getAll")
	public ResponseEntity<List<RevenueTransactionDto>> getAllRevenue() {
		List<RevenueTransactionDto> list = transactionService.getAll();
	...
	@GetMapping("/filter")
	public ResponseEntity<List<RevenueTransactionDto>> filterRevenueTrans(
		...
		List<RevenueTransactionDto> list = transactionService.filter(businessId, code, drcr, fromDate, toDate);
		return ResponseEntity.ok(list);
	}

	@GetMapping("/getProduct")
	public ResponseEntity<List<RevenueTransactionDto>> getProduct() {
		List<RevenueTransactionDto> list = transactionService.getProdcut();
